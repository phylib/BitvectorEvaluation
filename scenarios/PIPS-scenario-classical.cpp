...
main(int argc, char* argv[])
{
  ...
  callerHelper.SetAttribute ("LookaheadLiftime", IntegerValue(250));


  callerHelper.SetPrefix(prefixA_App);
  voipProducerHelper.SetPrefix(prefixA_App);
  callerHelper.Install(nodeA);
  voipProducerHelper.Install(nodeB);

  callerHelper.SetPrefix(prefixB_App);
  voipProducerHelper.SetPrefix(prefixB_App);
  callerHelper.Install(nodeB);
  voipProducerHelper.Install(nodeA);
